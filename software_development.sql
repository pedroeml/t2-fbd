...
CREATE TABLE FUNCIONARIO (
 ...
 CONTRATACAO DATE,
 CPF NUMBER(11)
 --O check constraint que tentei antes nao funciona, vou usar uma trigger
);
...
THEN 
RAISE_APPLICATION_ERROR (-20099, 'USUARIO NAO AUTORIZADO')
END IF;
END;
/
CREATE OR REPLACE TRIGGER ONLY_NUMBERS
	BEFORE INSERT OR UPDATE OF CODIGO_FUNCIONARIO ON FUNCIONARIO
REFERENCING NEW AS N OLD AS O 
FOR EACH ROW
	IF: N.CODIGO_FUNCIONARIO > 0  THEN
BEGIN
	CODIGO_FUNCIONARIO = N.CODIGO_FUNCIONARIO

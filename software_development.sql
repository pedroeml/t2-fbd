...
CREATE TABLE FUNCIONARIO (
 ...
 CONTRATACAO DATE,
 CPF NUMBER(11)
 CONSTRAINT CODIGO_FUNCIONARIO CHECK (CODIGO_FUNCIONARIO > 0) --GARANTE QUE SÓ HAJAM NÚMEROS NO CODIGO_FUNCIONARIO (QUE SERÁ TRATADO COMO CÓDIGO DE USÚARIO EM OUTRAS OPERAÇÕES)
);
...
INSERT INTO UTILIZA VALUES(10, 123456, '856123654');	-- DEKSTOPS DELL
INSERT INTO UTILIZA VALUES(10, 123457, '735468748');
INSERT INTO UTILIZA VALUES(8, 123458, '561215884');
INSERT INTO UTILIZA VALUES(8, 123459, '563654214');
INSERT INTO UTILIZA VALUES(8, 6567890, '569981235');	-- DESKTOPS LENOVO
INSERT INTO UTILIZA VALUES(8, 6567891, '568234562');
INSERT INTO UTILIZA VALUES(8, 6567892, '568971262');
INSERT INTO UTILIZA VALUES(8, 6567893, '561231587');
INSERT INTO UTILIZA VALUES(8, 6567894, '568898115');
INSERT INTO UTILIZA VALUES(10, 9876543210, '735468748');	-- MICROSOFT VISUAL STUDIO
INSERT INTO UTILIZA VALUES(8, 9876543211, '561215884');
INSERT INTO UTILIZA VALUES(8, 9876543212, '563654214');
...
INSERT INTO PLANEJA VALUES('735468748', '132001', TO_DATE('2015/03/10', 'yyyy/mm/dd'), TO_DATE('2015/03/25', 'yyyy/mm/dd'));
INSERT INTO PLANEJA VALUES('735468748', '132002', TO_DATE('2015/03/28', 'yyyy/mm/dd'), TO_DATE('2015/04/15', 'yyyy/mm/dd'));
INSERT INTO PLANEJA VALUES('735468748', '132003', TO_DATE('2015/04/18', 'yyyy/mm/dd'), TO_DATE('2015/05/29', 'yyyy/mm/dd'));
INSERT INTO PLANEJA VALUES('735468748', '139001', TO_DATE('2015/06/10', 'yyyy/mm/dd'), TO_DATE('2015/08/01', 'yyyy/mm/dd'));
INSERT INTO PLANEJA VALUES('735468748', '139002', TO_DATE('2015/08/06', 'yyyy/mm/dd'), TO_DATE('2015/12/01', 'yyyy/mm/dd'));

INSERT INTO DESIGN VALUES('132001', 'FACTORY, MVC, OBSERVER, CAMADAS', 'PRIMEFACES, SPRING', 'JAVA, ');
INSERT INTO DESIGN VALUES('132002', 'FACTORY, MVC, OBSERVER, CAMADAS, STRATEGY', 'PRIMEFACES, SPRING, LARAVEL', 'JAVA, PHP');
INSERT INTO DESIGN VALUES('132003', 'FACTORY, MVC, OBSERVER, CAMADAS, STRATEGY, PROTOTYPE', 'PRIMEFACES, SPRING, LARAVEL, BOOTSTRAP', 'JAVA, PHP, JAVASCRIPT, HTML, CSS');
INSERT INTO DESIGN VALUES('139001', 'OBSERVER, CAMADAS, PROTOTYPE', 'PRIMEFACES, LARAVEL', 'JAVA, PHP');
INSERT INTO DESIGN VALUES('139002', 'OBSERVER, CAMADAS, PROTOTYPE, FACTORY, STRATEGY', 'PRIMEFACES, LARAVEL, SPRING, BOOTSTRAP', 'JAVA, PHP, JAVASCRIPT, HTML, CSS');


INSERT INTO MODELO VALUES('1320015001', 'NEGOCIO, PERSISTENCIA', 'PRIMEIRA MODELAGEM DO PROJETO', '1.0.100');
INSERT INTO MODELO VALUES('1320026001', 'NEGOCIO, PERSISTENCIA', 'ADAPTACAO PARA MUDANCA NO DESIGN', '1.0.200');
INSERT INTO MODELO VALUES('1320037001', 'NEGOCIO, PERSISTENCIA, USUARIO', 'ADAPTACAO PARA MUDANCA NO DESIGN', '1.1.500');
INSERT INTO MODELO VALUES('1390015001', 'NEGOCIO, PERSISTENCIA', 'PRIMEIRA MODELAGEM DO PROJETO', '1.0.230');
INSERT INTO MODELO VALUES('1390026002', 'NEGOCIO, PERSISTENCIA, USUARIO', 'ADAPTACAO PARA MUDANCA NO DESIGN', '1.1.100');

INSERT INTO MODELA VALUES('569981235', '1320015001', TO_DATE('2015/03/12', 'yyyy/mm/dd'), TO_DATE('2015/03/15', 'yyyy/mm/dd'), 24);
INSERT INTO MODELA VALUES('569981235', '1320026001', TO_DATE('2015/03/29', 'yyyy/mm/dd'), TO_DATE('2015/04/02', 'yyyy/mm/dd'), 24);
INSERT INTO MODELA VALUES('569981235', '1320037001', TO_DATE('2015/04/19', 'yyyy/mm/dd'), TO_DATE('2015/04/21', 'yyyy/mm/dd'), 18);
INSERT INTO MODELA VALUES('569981235', '1390015001', TO_DATE('2015/06/13', 'yyyy/mm/dd'), TO_DATE('2015/06/16', 'yyyy/mm/dd'), 18);
INSERT INTO MODELA VALUES('569981235', '1390026001', TO_DATE('2015/08/08', 'yyyy/mm/dd'), TO_DATE('2015/08/11', 'yyyy/mm/dd'), 24);
...
-- SISTEMA			Mas esta tabela não possui coluna nenhuma...


COMMIT;


CREATE OR REPLACE TRIGGER BLOCK_FINISHED_OP
	BEFORE INSERT OR DELETE OR UPDATE OF REQUISITOS, ATIVIDADES, INICIO, FIM, CODIGO_PROJETO ON PROJETO
REFERENCING NEW AS N OLD AS O
FOR EACH ROW
DECLARE USUARIO VARCHAR;
BEGIN
SELECT USER INTO USUARIO FROM DUAL;
	IF :  USUARIO < 6000000000
THEN 
RAISE_APPLICATION_ERROR (-20099, 'USUÁRIO NAO AUTORIZADO')
END IF;
END;
